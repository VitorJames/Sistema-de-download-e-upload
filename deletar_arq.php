		...
		<div class="col-md-12 column">
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">				
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">	
					...
					<div id="btns">
						<center>
							<a href="logado_adm.php"><button class="btn-bar-adm">Voltar</button></a>
						</center>
					</div>
				</div>
			</nav>
...
<div id="inf2"><br><br><br><br><br>
	<center>
		<font size="6" color="white">Lista de Arquivos</font><br><br><br>
<?php
session_start();
...
if($arquivo != '.' && $arquivo != '..'){	
echo "<form action='apagado.php' method='POST'>
...
echo "<input type='submit' value='Deletar' class='del-button'></form><br>";
?>